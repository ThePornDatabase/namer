...
class PartialFormatter(string.Formatter):
    ...
    def _verify_name_string(self, name: str, name_string: str) -> bool:
        """
    ...
    * 'trans' - 'TS', or 'ts' if detected in original file name.
    ...
    def verify_naming_config(self) -> bool:
        ...
        if self.enable_metadataapi_genres is not True and self.default_genre is None:
            ...
            success = False
        success = PartialFormatter()._verify_name_string("inplace_name", self.inplace_name) and success
        return success
    ...
    def verify_watchdog_config(self) -> bool:
        ...
        success = PartialFormatter()._verify_name_string("new_relative_path_name", self.new_relative_path_name) and success
        return success
